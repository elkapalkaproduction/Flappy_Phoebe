...
static LogoViewController *logo;
...
void ios_show_revmob_banner(bool shwon)
{
	/*if (sk::game_services::is_interstitial_shown())
     {
     return;
...
- (void) rm_baner:(bool)shown
{
    ...
    /*if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        revMobAds.bannerView.frame = CGRectMake(0, 0, 768, 114);
    } else {
        revMobAds.bannerView.frame = CGRectMake(0, 0, 320, 50);
    }*/
